...
describe('ResolutionSession', () => {
  ...
  // it.skip('popBinding() reports error if the top element is not a binding', () => {
  //   const injection: Injection = givenInjection();
  //   session.pushInjection(injection);
  ...
  // it.skip('popInjection() reports error if the top element is not an injection', () => {
  //   const binding = new Binding('a');
  //   session.pushBinding(binding);
  ...
  // it.skip('tracks mixed bindings and injections', () => {
  ...
  describe('runWithBinding()', () => {
    ...
    //   expect(val).to.eql('ok');
    // });
    // it.skip('pushes/pops the binding atomically for a sync action', () => {
    //   const session1 = new ResolutionSession();
    //   const bindingA = new Binding('a');
    //   session1.pushBinding(bindingA);
    //   const injection: Injection = givenInjection();
    ...
    // });
    // it.skip('pushes/pops the binding atomically for a failed sync action', () => {
    //   const session1 = new ResolutionSession();
    //   const bindingA = new Binding('a');
    //   session1.pushBinding(bindingA);
    //   const injection: Injection = givenInjection();
    ...
    //   expect(session1.injectionStack).to.be.eql([injection]);
    // });
    // it.skip('pushes/pops the binding atomically for an async action', async () => {
    //   const session1 = new ResolutionSession();
    //   const bindingA = new Binding('a');
    //   session1.pushBinding(bindingA);
    //   const injection: Injection = givenInjection();
    ...
    //   expect(session1.injectionStack).to.be.eql([injection]);
    // });
    // it.skip('pushes/pops the binding atomically for a failed action', async () => {
    //   const session1 = new ResolutionSession();
    //   const bindingA = new Binding('a');
    //   session1.pushBinding(bindingA);
    //   const injection: Injection = givenInjection();
  ...
  describe('runWithInjection()', () => {
    // it.skip('allows current session to be undefined', () => {
    //   const injection = givenInjection();
    //   const val = ResolutionSession.runWithInjection(() => 'ok', injection);
    //   expect(val).to.eql('ok');
    // });
    // it.skip('allows a promise to be returned', async () => {
    //   const injection = givenInjection();
    ...
    //   expect(val).to.eql('ok');
    // });
    // it.skip('pushes/pops the injection atomically for a sync action', () => {
    //   const session1 = new ResolutionSession();
    //   const bindingA = new Binding('a');
    //   session1.pushBinding(bindingA);
    //   const injection: Injection = givenInjection();
    ...
    // });
    // it.skip('pushes/pops the injection atomically for a failed sync action', () => {
    //   const session1 = new ResolutionSession();
    //   const bindingA = new Binding('a');
    //   session1.pushBinding(bindingA);
    //   const injection: Injection = givenInjection();
    ...
    //   expect(session1.injectionStack).to.be.eql([]);
    // });
    // it.skip('pushes/pops the injection atomically for an async action', async () => {
    //   const session1 = new ResolutionSession();
    //   const bindingA = new Binding('a');
    //   session1.pushBinding(bindingA);
    //   const injection: Injection = givenInjection();
    ...
    //   expect(session1.injectionStack).to.be.eql([]);
    // });
    // it.skip('pushes/pops the injection atomically for a failed async action', async () => {
    //   const session1 = new ResolutionSession();
    //   const bindingA = new Binding('a');
    //   session1.pushBinding(bindingA);
    //   const injection: Injection = givenInjection();
